    ...
    var body: some View {
        HStack(spacing: 0) {
            Text(verbatim: "pilltalk/")
                .pilltalkFont(size: 18, weight: .medium)
                .lineLimit(1)
                ...
                .accessibilityHint(
                    String(localized: "content.accessibility.app_info_hint", comment: "Accessibility hint on the pilltalk/ logo explaining a tap opens app info")
                )
                .accessibilityAction {
