...
struct TextMessageView: View {
    ...
    /// construction. `PilltalkMessage` is a reference type mutated in place by
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            if message.content.isLongForDisplay() {
                ...
                .pilltalkFont(size: 11, weight: .medium)
...
// (PreviewKeychainManager, PilltalkMessage.preview), a development asset
