...
extension Notification.Name {
    ...
    static let geoRelayDirectoryDidRefresh = Notification.Name("pilltalk.geoRelayDirectoryDidRefresh")
}
        ...
        return Self(
            ...
            cacheURL: {
                do {
                    ...
                    let dir = base.appendingPathComponent("pilltalk", isDirectory: true)
