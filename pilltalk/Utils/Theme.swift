...
/// Themed replacement for `.font(.pilltalkSystem(size:weight:design: .monospaced))`:
...
private struct ThemedFontModifier: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content.font(.pilltalkSystem(size: size, weight: weight, design: theme.bodyFontDesign))
    }
}
...
extension View {
    func pilltalkFont(size: CGFloat, weight: Font.Weight = .regular) -> some View {
