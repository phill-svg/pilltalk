...
/// # PilltalkProtocol
///
/// Defines the application-layer protocol for PillTalk mesh networking, including
/// message types, packet structures, and encoding/decoding logic.
///
/// ## Overview
/// PilltalkProtocol implements a binary protocol optimized for Bluetooth LE's
...
protocol PilltalkDelegate: AnyObject {
