...
final class PublicMessagePipeline {
    ...
    private var buffer: [(message: PilltalkMessage, conversationID: ConversationID)] = []
    ...
    func enqueue(_ message: PilltalkMessage, to conversationID: ConversationID) {
...
private extension PublicMessagePipeline {
    ...
    func flushBuffer() {
        ...
        var pending: [(message: PilltalkMessage, conversationID: ConversationID, contentKey: String)] = []
