...
protocol ChatPublicConversationContext: AnyObject {
    ...
    func cleanupLocalFile(forMessage message: PilltalkMessage)
    ...
    func processActionMessage(_ message: PilltalkMessage) -> PilltalkMessage
    func isMessageBlocked(_ message: PilltalkMessage) -> Bool
    ...
    func enqueuePublicMessage(_ message: PilltalkMessage, to conversationID: ConversationID)
    ...
    func prewarmMessageFormatting(_ message: PilltalkMessage)
...
final class ChatPublicConversationCoordinator: PublicMessagePipelineDelegate {
    ...
    func blockGeohashUser(pubkeyHexLowercased: String, displayName: String) {
        ...
        if let gh = context.currentGeohash {
            let predicate: (PilltalkMessage) -> Bool = { [unowned context] message in
    ...
    func handlePublicMessage(_ message: PilltalkMessage, powBits: Int = 0) {
    ...
    func pipeline(_: PublicMessagePipeline, commit message: PilltalkMessage, to conversationID: ConversationID) -> Bool {
        context.appendPublicMessage(message, to: conversationID)
    }

    func pipelinePrewarmMessage(_: PublicMessagePipeline, message: PilltalkMessage) {
...
private extension ChatPublicConversationCoordinator {
    func normalizedSenderKey(for message: PilltalkMessage) -> String {
