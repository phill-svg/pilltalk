...
protocol ChatLiveVoiceContext: AnyObject {
    ...
    func appendPublicMeshMessage(_ message: PilltalkMessage)
...
final class ChatLiveVoiceCoordinator {
    ...
    private final class Assembly {
        ...
        init(burstID: Data, peerID: PeerID, scope: VoiceBurstScope, nickname: String, message: PilltalkMessage, fileURL: URL, fileHandle: FileHandle) {
    ...
    /// notification.
    func absorbFinalizedVoiceNote(_ message: PilltalkMessage) -> Bool {
        ...
        let replacement = PilltalkMessage(
