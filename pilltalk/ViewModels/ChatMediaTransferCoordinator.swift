...
protocol ChatMediaTransferContext: AnyObject {
    ...
    func sendFilePrivate(_ packet: PilltalkFilePacket, to peerID: PeerID, transferId: String)
    func sendFileBroadcast(_ packet: PilltalkFilePacket, transferId: String)
...
final class ChatMediaTransferCoordinator {
    ...
    func enqueueMediaMessage(content: String, targetPeer: PeerID?) -> PilltalkMessage {
        let timestamp = Date()
