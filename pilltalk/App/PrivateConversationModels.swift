...
final class PrivateInboxModel: ObservableObject {
    ...
    func messages(for peerID: PeerID?) -> [PilltalkMessage] {
...
final class PrivateConversationModel: ObservableObject {
    ...
    private func resolveAvailability(for headerPeerID: PeerID, peer: PilltalkPeer?) -> PrivateConversationAvailability {
