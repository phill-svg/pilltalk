...
struct BLERouteForwardingPlan {
    ...
    let forwardPacket: PilltalkPacket?
    let nextHop: PeerID?
    ...
    static func forward(_ packet: PilltalkPacket, to nextHop: PeerID) -> BLERouteForwardingPlan {
...
struct BLERouteForwardingPolicy {
    ...
    private static func relayed(_ packet: PilltalkPacket) -> PilltalkPacket {
