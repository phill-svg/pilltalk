...
final class MessageFormattingEngine {
    ...
    static func formatHeader(
        ...
        if message.sender == "system" {
            ...
            style.font = .pilltalkSystem(size: 14, weight: .medium, design: .monospaced)
    ...
    private static func formatSystemMessage(_ message: PilltalkMessage, isDark _: Bool) -> AttributedString {
        var result = AttributedString()

        let content = AttributedString("* \(message.content) *")
        var contentStyle = AttributeContainer()
        contentStyle.foregroundColor = Color.gray
        contentStyle.font = .pilltalkSystem(size: 12, design: .monospaced).italic()
        ...
        timestampStyle.font = .pilltalkSystem(size: 10, design: .monospaced)
    ...
    private static func formatSenderHeader(
        ...
        senderStyle.font = .pilltalkSystem(size: 14, weight: fontWeight, design: .monospaced)
    ...
    private static func formatPlainContent(_ content: String, baseColor: Color, isSelf: Bool) -> AttributedString {
        ...
        style.foregroundColor = baseColor
        style.font = isSelf
            ? .pilltalkSystem(size: 14, weight: .bold, design: .monospaced)
            : .pilltalkSystem(size: 14, design: .monospaced)
    ...
    private static func formatMatch(_ text: String, type: MatchType, baseColor _: Color, isSelf _: Bool) -> AttributedString {
        ...
        case .mention:
            ...
            mentionStyle.font = .pilltalkSystem(size: 14, weight: .semibold, design: .monospaced)
        ...
        case .url:
            ...
            style.font = .pilltalkSystem(size: 14, design: .monospaced)
    ...
    private static func formatTimestamp(_ timestamp: String) -> AttributedString {
        ...
        style.font = .pilltalkSystem(size: 10, design: .monospaced)
