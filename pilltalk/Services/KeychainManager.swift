...
final class KeychainManager: KeychainManagerProtocol {
    ...
    private let service = PilltalkApp.bundleID
    private let appGroup = "group.\(PilltalkApp.bundleID)"
    #if os(iOS)
    ...
    private static let additionalApplicationOwnedServices = [
        ...
        "com.pilltalk.passwords",
        "com.pilltalk.deviceidentity",
        "com.pilltalk.noise.identity",
        "chat.pilltalk.passwords",
        "pilltalk.keychain",
        "pilltalk",
        "com.pilltalk"
    ]
    ...
    private func saveDataWithResult(_ data: Data, forKey key: String, retryCount: Int = 2) -> KeychainSaveResult {
        ...
        var base: [String: Any] = [
            ...
            kSecAttrAccessible as String: Self.itemAccessibility,
            kSecAttrLabel as String: "pilltalk-\(key)"
        ]
        #if os(macOS)
