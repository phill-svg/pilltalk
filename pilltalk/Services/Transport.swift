...
enum TransportEvent: @unchecked Sendable {
    case messageReceived(PilltalkMessage)
...
protocol Transport: AnyObject {
    // Event sink
    var delegate: PilltalkDelegate? { get set }
    // Typed event sink for transport-domain events. Prefer this over PilltalkDelegate for new code.
