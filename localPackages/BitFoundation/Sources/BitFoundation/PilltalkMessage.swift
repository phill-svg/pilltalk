...
/// Represents a user-visible message in the PillTalk system.
/// Handles both broadcast messages and private encrypted messages,
/// with support for mentions, replies, and delivery tracking.
/// - Note: This is the primary data model for chat messages
public final class PilltalkMessage: Codable {
...
extension PilltalkMessage: Equatable {
    public static func == (lhs: PilltalkMessage, rhs: PilltalkMessage) -> Bool {
