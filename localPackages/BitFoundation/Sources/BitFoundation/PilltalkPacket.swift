...
/// The core packet structure for all PillTalk protocol messages.
/// Encapsulates all data needed for routing through the mesh network,
/// including TTL for hop limiting and optional encryption.
/// - Note: Packets larger than BLE MTU (512 bytes) are automatically fragmented
public struct PilltalkPacket: Codable {
    ...
    public func toBinaryDataForSigning() -> Data? {
        ...
        let unsignedPacket = PilltalkPacket(
            type: type,
            senderID: senderID,
    ...
    public static func from(_ data: Data) -> PilltalkPacket? {
