...
- **File:** `pilltalkTests/Mocks/MockBLEService.swift`
...
- **Handlers:** Tests can observe data via `messageDeliveryHandler` (decoded `PilltalkMessage`) and `packetDeliveryHandler` (raw `PilltalkPacket`).
