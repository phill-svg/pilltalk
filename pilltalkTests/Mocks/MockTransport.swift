...
final class MockTransport: Transport {
    ...
    private(set) var sentBroadcastFiles: [(packet: PilltalkFilePacket, transferID: String)] = []
    private(set) var sentPrivateFiles: [(packet: PilltalkFilePacket, peerID: PeerID, transferID: String)] = []
