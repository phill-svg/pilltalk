...
private final class MockChatVerificationContext: ChatVerificationContext {
    ...
    // Peers
    var unifiedPeers: [PilltalkPeer] = []
    var unifiedFavorites: [PilltalkPeer] = []
...
struct ChatVerificationCoordinatorContextTests {
    ...
    func beginQRVerification_sendsChallengeOrTriggersHandshake() async {
        ...
        context.unifiedPeers = [PilltalkPeer(peerID: peerID, noisePublicKey: noiseKey, nickname: "alice")]
        #expect(coordinator.beginQRVerification(with: qr))
        ...
        context2.unifiedPeers = [PilltalkPeer(peerID: peerID, noisePublicKey: noiseKey, nickname: "alice")]
