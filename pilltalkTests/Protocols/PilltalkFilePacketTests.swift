...
final class PilltalkFilePacketTests: XCTestCase {
    ...
    func testRoundTripPreservesFields() throws {
        ...
        guard let decoded = PilltalkFilePacket.decode(encoded) else {
    ...
    func testDecodeSupportsLegacyEightByteFileSizeTLV() throws {
        ...
        let decoded = try XCTUnwrap(PilltalkFilePacket.decode(data))
