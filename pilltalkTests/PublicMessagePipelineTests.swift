...
private final class TestPipelineDelegate: PublicMessagePipelineDelegate {
    ...
    private(set) var committed: [(message: PilltalkMessage, conversationID: ConversationID)] = []
    ...
    func messages(in conversationID: ConversationID) -> [PilltalkMessage] {
...
@MainActor
private func makeMessage(id: String, content: String, timestamp: Date) -> PilltalkMessage {
    PilltalkMessage(
        id: id,
        sender: "A",
        content: content,
