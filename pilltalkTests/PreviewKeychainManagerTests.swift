...
struct PreviewKeychainManagerTests {
    ...
    func accessibilityMigrationCoversEveryApplicationOwnedService() {
        let primaryService = "chat.pilltalk.test-primary"
        ...
        let completed = KeychainManager
            .migrateAccessibilityForApplicationOwnedServices(
                ...
                return service == "chat.pilltalk.favorites"
        ...
        #expect(Set(visitedServices).isSuperset(of: [
            "chat.pilltalk.nostr",
            "chat.pilltalk.favorites",
            "chat.pilltalk.outbox"
        ]))
    ...
    func keychainCleanupRequiresEveryApplicationOwnedService() {
        ...
        let partialCleanup = KeychainManager
            .deleteApplicationOwnedKeychainServices(
                ...
                visitedServices.append(service)
                return service == "chat.pilltalk.outbox"
                    ? errSecInteractionNotAllowed
                    : errSecSuccess
            }
    ...
    func failedReinstallCleanupBlocksEveryNamespaceUntilSuccessfulRetry() {
        ...
        manager.save(
            key: "favorite",
            data: staleFavorite,
            service: "chat.pilltalk.favorites",
            accessible: nil
        )
        manager.save(
            key: "outbox",
            data: staleOutbox,
            service: "chat.pilltalk.outbox",
            accessible: nil
        )
        manager.save(
            key: "custom",
            data: staleCustom,
            service: "chat.pilltalk.future-custom",
            accessible: nil
        )
        ...
        for (key, service) in [
            ("favorite", "chat.pilltalk.favorites"),
            ("outbox", "chat.pilltalk.outbox"),
            ("custom", "chat.pilltalk.future-custom")
        ] {
