...
private final class MockChatLiveVoiceContext: ChatLiveVoiceContext {
    ...
    private(set) var handledPrivateMessages: [PilltalkMessage] = []
    private(set) var appendedPublicMessages: [PilltalkMessage] = []
    private(set) var upsertedMessages: [(message: PilltalkMessage, peerID: PeerID)] = []
    private(set) var upsertedPublicMessages: [PilltalkMessage] = []
    ...
    func handlePrivateMessage(_ message: PilltalkMessage) { handledPrivateMessages.append(message) }
    func appendPublicMeshMessage(_ message: PilltalkMessage) { appendedPublicMessages.append(message) }
    func upsertPrivateMessage(_ message: PilltalkMessage, in peerID: PeerID) {
        upsertedMessages.append((message, peerID))
    }
    func upsertPublicMeshMessage(_ message: PilltalkMessage) {
...
struct ChatLiveVoiceCoordinatorTests {
    ...
    @Test func absorbIgnoresUnrelatedVoiceNotes() throws {
        ...
        let liveCapture = PilltalkMessage(
    ...
    @Test func absorbEnforcesScopeBinding() throws {
        ...
        let publicNote = PilltalkMessage(
    ...
    @Test func finalizedNoteBindsToItsAuthenticatedSender() throws {
        ...
        let attackerNote = PilltalkMessage(
