...
struct GossipSyncManagerTests {
    ...
    @Test func staleAnnouncementsArePurgedWithMessages() throws {
        ...
        let announcePacket = PilltalkPacket(
        ...
        let messagePacket = PilltalkPacket(
            type: MessageType.message.rawValue,
            senderID: senderData,
            recipientID: nil,
            timestamp: initialTimestampMs,
    ...
    @Test func removePublicMessagesPurgesOnlyThatSender() throws {
        ...
        manager.onPublicPacketSeen(PilltalkPacket(
            type: MessageType.announce.rawValue,
    ...
    @Test func ignoresAnnounceOlderThanStaleTimeout() throws {
        ...
        let freshMessage = PilltalkPacket(
            type: MessageType.message.rawValue,
            senderID: senderData,
            recipientID: nil,
    ...
    @Test func maintenanceEmitsTypedSyncRequests() throws {
        ...
        let fragmentPacket = PilltalkPacket(
    ...
    private func makeFragmentPacket(sender: Data, fragmentID: Data, index: UInt16, timestamp: UInt64) -> PilltalkPacket {
    ...
    @Test func prekeyBundlesServeSyncAndSurviveStalePeerCleanup() async throws {
        ...
        let bundlePacket = PilltalkPacket(
...
private final class RecordingDelegate: GossipSyncManager.Delegate {
    ...
    private(set) var lastPacket: PilltalkPacket?
    private(set) var packets: [PilltalkPacket] = []
