...
final class SecureIdentityStateManagerTests: XCTestCase {
    ...
    func test_corruptPersistedCache_fallsBackToEmptyState() {
        ...
        _ = keychain.saveIdentityKey(Data([0xFF, 0x00, 0xAA]), forKey: "pilltalk.identityCache.v2")
        ...
        XCTAssertNil(keychain.getIdentityKey(forKey: "pilltalk.identityCache.v2"))
    }
...
private final class FailingCacheSaveKeychain: KeychainManagerProtocol {
    ...
    func saveIdentityKey(_ keyData: Data, forKey key: String) -> Bool {
        if key == "pilltalk.identityCache.v2" {
            return false
        }
        storage[key] = keyData
        return true
