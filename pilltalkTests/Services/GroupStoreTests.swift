...
struct GroupStoreTests {
    ...
    @Test func createGroupStoresMetadataAndKey() throws {
        ...
        #expect(group.groupID.count == PilltalkGroup.groupIDLength)
        ...
        #expect(key.count == PilltalkGroup.keyLength)
    ...
    @Test func rosterCapIsEnforced() throws {
        ...
        #expect(store.group(withID: group.groupID)?.members.count == PilltalkGroup.maxMembers)
