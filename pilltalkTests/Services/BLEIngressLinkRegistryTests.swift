...
private func makePacket(sender: PeerID, timestamp: UInt64) -> PilltalkPacket {
    PilltalkPacket(
...
private func makeRequestSyncPacket(sender: PeerID) -> PilltalkPacket {
    PilltalkPacket(
...
private func makeAnnouncePacket(sender: PeerID, ttl: UInt8) -> PilltalkPacket {
    PilltalkPacket(
