...
struct BLEFragmentAssemblyBufferTests {
    ...
    private func makePacket(payload: Data, timestamp: UInt64 = 0x0102030405) -> PilltalkPacket {
        PilltalkPacket(
    ...
    private func makeFragments(for packet: PilltalkPacket, chunkSize: Int, fragmentID: Data) throws -> [PilltalkPacket] {
