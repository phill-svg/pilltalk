...
struct BoardStoreTests {
    ...
    ) throws -> (wire: BoardWire, packet: PilltalkPacket, post: BoardPostPacket) {
    ...
    private func makeTombstone(
        ...
        deletedAt: UInt64,
        claimKey: Data? = nil
    ) throws -> (wire: BoardWire, packet: PilltalkPacket) {
    ...
    private func makePacket(payload: Data, timestamp: UInt64) -> PilltalkPacket {
        PilltalkPacket(
    ...
    @Test func orphanTombstonePerAuthorCapEvictsOldest() throws {
        ...
        var unseenPosts: [(wire: BoardWire, packet: PilltalkPacket, post: BoardPostPacket)] = []
