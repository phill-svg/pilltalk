...
struct NotificationStreamAssemblerTests {
    private func makePacket(timestamp: UInt64 = 0x0102030405) -> PilltalkPacket {
    ...
    func testAssemblesCompressedLargeFrame() throws {
        ...
        let decodedFile = try #require(PilltalkFilePacket.decode(decodedPacket.payload), "Failed to decode TLV payload")
